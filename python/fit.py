...
class Fit(object) :
	...
	def _buildDatacard_(self,region,topology,leptype,tfilepath) :
		...
		rqcdvals = {'t1_muplus_SR':0.249,
					't1_muminus_SR':-0.290,
					't1_elplus_SR':-0.040,
					't1_elminus_SR':0.497,
					't1_muplus_WJets_CR':0.628,
					...
					't2_muminus_WJets_CR':-0.361,
					't2_elplus_WJets_CR':0.245,
					't2_elminus_WJets_CR':0.251,
					't3_muplus_SR':-0.102,
					't3_muminus_SR':-0.094,
					't3_elplus_SR':-0.487,
					't3_elminus_SR':-0.512,
					}
		rqcderrs = {'t1_muplus_SR':0.509,
					't1_muminus_SR':0.383,
					't1_elplus_SR':0.141,
					't1_elminus_SR':0.226,
					't1_muplus_WJets_CR':0.230,
					't1_muminus_WJets_CR':0.1,
					't1_elplus_WJets_CR':0.1,
					't1_elminus_WJets_CR':0.1,
					't2_muplus_SR':0.125,
					't2_muminus_SR':0.147,
					't2_elplus_SR':0.1,
					't2_elminus_SR':0.1,
					't2_muplus_WJets_CR':0.1,
					't2_muminus_WJets_CR':0.147,
					't2_elplus_WJets_CR':0.1,
					't2_elminus_WJets_CR':0.1,
					't3_muplus_SR':0.1,
					't3_muminus_SR':0.1,
					't3_elplus_SR':0.1,
					't3_elminus_SR':0.1,
