...
class Fit(object) :
	...
	def _buildDatacard_(self,region,topology,leptype,tfilepath) :
		...
		rqcdvals = {'t1_muplus_SR':0.704,
					't1_muminus_SR':0.228,
					't1_elplus_SR':0.310,
					't1_elminus_SR':0.668,
					't1_muplus_WJets_CR':0.597,
					't1_muminus_WJets_CR':0.704,
					't1_elplus_WJets_CR':0.669,
					...
					't2_muminus_WJets_CR':-0.316,
					't2_elplus_WJets_CR':0.121,
					't2_elminus_WJets_CR':0.156,
					't3_muplus_SR':-0.057,
					't3_muminus_SR':-0.038,
					't3_elplus_SR':-0.369,
					't3_elminus_SR':-0.465,
					}
		rqcderrs = {'t1_muplus_SR':0.3,
					't1_muminus_SR':0.392,
					't1_elplus_SR':0.3,
					't1_elminus_SR':0.3,
